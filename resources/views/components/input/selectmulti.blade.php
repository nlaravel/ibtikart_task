...
<div wire:ignore  x-data
    ...
    <fieldset class="form-group">
        ...
        <select id="{{$id}}"  name="{{$attributes['name']}}"  @if(isset($attributes['multiple'])) multiple ="{{$attributes['multiple']}}"  @endif class="form-control select2  @error($attributes['name']) is-invalid @enderror" >
