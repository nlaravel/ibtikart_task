    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">خصائص المنتج</h2>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('dashboard')}}" >@lang('lang.Dashboard')</a>
                            </li>
                            <li class="breadcrumb-item active">خصائص المنتج</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="top">
                        <div class="actions action-btns">
                            ...
                            <div class="dt-buttons btn-group">
                                <a href="{{route('dashboard.attribute.create')}}"  class="btn btn-outline-primary mr-1 mb-1 waves-effect waves-light"><i class="feather icon-plus-circle"></i>
                                   اضافة خاصية جديدة
                                </a>
                            </div>
