                    ...
                    <div class="top">
                        <div class="actions action-btns">
                            ...
                            <div class="dt-buttons btn-group">
                                <a href="{{route('dashboard.product.create')}}"  class="btn btn-outline-primary mr-1 mb-1 waves-effect waves-light"><i class="feather icon-plus-circle"></i>
                                 اضافة منتج
                                </a>
                            </div>
