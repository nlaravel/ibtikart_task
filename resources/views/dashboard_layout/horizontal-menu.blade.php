            ...
            <div class="navbar-collapse" id="navbar-mobile">
                ...
                <!-- End: Main Menu- user notification-->
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="javascript:;" data-toggle="dropdown">
                            ...
                            @else
                                <span><img class="round" src="{{auth()->user()->avatarUrl()}}" alt="avatar" style="height: 40px;" height="40" width="40"></span>

                            @endif
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">

                            <a class="dropdown-item" href="{{route('dashboard.profile')}}"><i class="feather icon-user"></i>@lang('lang.Profile')</a>
